...
/**
 * Object containing information about the modules being imported & it's corresponding AST node
 * @typedef {Object} ModuleInfo
 * @property {String} moduleInfo.type - Contains detail about the type of require/import statement. Possible values include Literal, ArrayExpression, ImportDeclaration
...
/**
 * Checks if the given node is a require statement function call with an array as it's first argument
 * This function will return true for the following statement
 * require([ 'account' ], account => .....)
 *
 * This function will return false for the following statement
